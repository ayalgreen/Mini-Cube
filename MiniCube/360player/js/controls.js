  ...
  var controls = {
    ...
    create: function() {
      ...
      videoSelect.addEventListener('change', function() {
        ...
        controls.loadVideo(videoSelect.value);
     ...
     */
    loaded: function() {
      window.Load.classList.add('hidden');
      if (video.paused) {
        window.Play.classList.remove('hidden');
      }
    },
    ...
    loadVideo: function(videoFile) {
      controls.pause();
      window.Play.classList.add('hidden');
      window.Load.classList.remove('hidden');
    ...
    hide: function() {
      ...
      window.messageC.classList.add('hidden');
    },

    show: function() {
      window.videoControls.classList.remove('hidden');
      window.messageC.classList.remove('hidden');
    }
  };
